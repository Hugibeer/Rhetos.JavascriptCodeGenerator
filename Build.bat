...
NuGet.exe restore JavascriptCodeGenerator\JavascriptCodeGenerator.sln -NonInteractive || GOTO Error1
MSBuild.exe JavascriptCodeGenerator\JavascriptCodeGenerator.sln /target:rebuild /p:Configuration=Debug /verbosity:minimal /fileLogger || GOTO Error1
IF NOT EXIST Install md Install
NuGet.exe pack Rhetos.JavascriptCodeGenerator.nuspec -o Install || GOTO Error1
